<template>
    <table class="uk-table uk-table-small uk-table-divider">
      <tbody>
        <template v-for="(pray, index) in prays">
          <tr v-if="pray.name != 'imsak'" v-bind:class="{ next: pray.name == azanNext }">
            <td>
            ...
            <td>
              <button :class="notifications[index] ? 'uk-button uk-button-primary uk-button-small': 'uk-button uk-button-default uk-button-small'" v-on:click="click(index)">
...
export default{
  ...
  methods: {
    click: function (index) {
      this.notifications[index] = !this.notifications[index];
